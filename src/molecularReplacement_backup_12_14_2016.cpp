...
void printScoresToFile(Vector &degOfFreedoms, vector<ProteinStruct> Proteins, XRayStruct &xray, XRayStruct &expXRay, ofstream &file, XRayParamStruct &params, int index)
{
	//Prints all of the components of XRayScore for a replica.
	...
	name=base+suffix+"_"+toStr(index)+".pdb";
	...
	file <<diffOfSqrs<<"\t"<<r<<"\t"<<pearson<<"\t"<<clashCC<<"\t"<<clashCS<<"\t"<<clashSS<<"\t"<<total<<"\t"<<name<<endl;
...
void calcAccurateScores(Matrix &degOfFreedoms, vector<ProteinStruct> &Proteins, XRayStruct &xray, XRayStruct &expXRay, Matrix &scores, XRayParamStruct &params)
{
	int nrep=degOfFreedoms.size();
...
void printScoresToFile(Matrix &degOfFreedoms, vector<ProteinStruct> &Proteins, XRayStruct &xray, XRayStruct &expXRay, XRayParamStruct &params)
{
	...
	for (int i=0;i<nrep;i++)
	{
		printScoresToFile(degOfFreedoms[i], Proteins, xray, expXRay, file, params, i);
	}
}
